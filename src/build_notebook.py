...
OUT = ROOT / "notebooks" / "gambia_analysis.ipynb"
...
cells.append(nbf.v4.new_markdown_cell(
    ...
    "A walk-through of every indicator and every figure in the dashboard. "
    "Run the cells top to bottom. The data is fetched once from the World "
    "Bank then cached as CSV.\n\n"
...
cells.append(nbf.v4.new_markdown_cell(
    ...
    "If `data/clean/gambia_clean.csv` doesn't exist yet, run "
    "`python src/fetch_data.py` and `python src/clean.py` from the repo root first."
))
cells.append(nbf.v4.new_code_cell(
...
cells.append(nbf.v4.new_markdown_cell(
    ...
    "These two are the most-tracked development indicators in any country. "
